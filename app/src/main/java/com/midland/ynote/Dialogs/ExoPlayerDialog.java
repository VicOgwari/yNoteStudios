...
public class ExoPlayerDialog extends Dialog implements Player.EventListener {
    ...
    ImageView imageViewExit, imageOpen, imageComments, imageRatings;
    String videoUri;
    ...
    public ExoPlayerDialog(@NonNull Context context, Activity a, String videoUri) {
        super(context);
        this.a = a;
    ...
    public static Intent getStartIntent(Context context, String videoUri) {
        Intent intent = new Intent(context, ExoPlayerDialog.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageComments = findViewById(R.id.vidComments);
        imageRatings = findViewById(R.id.vidRatings);
        imageOpen = findViewById(R.id.open);
        ...
        imageComments.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    private void buildMediaSource(Uri mUri) {
        ...
        DataSource.Factory dataSourceFactory = new DefaultDataSourceFactory(getContext(),
                Util.getUserAgent(getContext(), getContext().getString(R.string.app_name)), bandwidthMeter);
...
//        MediaSource videoSource = new ExtractorMediaSource(mUri, sourceFactory, extractorsFactory, null, null);
        ...
        player.addListener(ExoPlayerDialog.this);
    }
