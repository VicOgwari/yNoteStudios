...
public class ExoPlayerActivity extends AppCompatActivity implements Player.EventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageViewExit.setOnClickListener(v -> finish());
    ...
    private void setUp() {
        ...
        Toast.makeText(ExoPlayerActivity.this, videoUri, Toast.LENGTH_SHORT).show();
    ...
    private void initializePlayer() {
        if (player == null) {
            ...
            // 2. Create the player
            player = ExoPlayerFactory.newSimpleInstance(ExoPlayerActivity.this,
                    new DefaultRenderersFactory(ExoPlayerActivity.this), trackSelector, loadControl);
    ...
    private void buildMediaSource(Uri mUri) {
        ...
        DataSource.Factory dataSourceFactory = new DefaultDataSourceFactory(ExoPlayerActivity.this,
                Util.getUserAgent(ExoPlayerActivity.this, getString(R.string.app_name)), bandwidthMeter);
...
//        MediaSource videoSource = new ExtractorMediaSource(mUri, sourceFactory, extractorsFactory, null, null);
        ...
        player.addListener(ExoPlayerActivity.this);
    }
